...
namespace Blog
{
    public class HasCredentialAttribute : AuthorizeAttribute
    {
        ...
        {
            var session = (UserLogin)HttpContext.Current.Session[Common.CommonConstans.USER_SESSION];
        ...
        {
            var credentials = (List<string>)HttpContext.Current.Session[Common.CommonConstans.SESSION_CREDENTIALS];
            return credentials;
        }
    }
}