...
SpellCheckAsYouType (SCAYT) instantly underlines spelling and grammar errors while userss type. To correct spelling or grammar error, a users simply needs to right-click the marked word to select from suggested corrections.
