...
<script runat="server">
    ...
    /**
	 * This function must check the users session to be sure that he/she is
    ...
    public override void SetConfig()
    {
        ...
        // "role" of the current users. The "role" is optional and can be used
        // in the "AccessControl" settings (bellow in this file).
        RoleSessionVar = "CKFinder_usersRole";
