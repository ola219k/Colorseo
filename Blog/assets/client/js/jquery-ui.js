...
// deprecated
$.ui.ie = !!/msie [\w.]+/.exec( navigator.usersAgent.toLowerCase() );
...
$.widget("ui.draggable", $.ui.mouse, {
	...
	_setContainment: function() {
		...
		isusersScrollable = /(scroll|auto)/.test( c.css( "overflow" ) );

		this.containment = [
			( parseInt( c.css( "borderLeftWidth" ), 10 ) || 0 ) + ( parseInt( c.css( "paddingLeft" ), 10 ) || 0 ),
			( parseInt( c.css( "borderTopWidth" ), 10 ) || 0 ) + ( parseInt( c.css( "paddingTop" ), 10 ) || 0 ),
			( isusersScrollable ? Math.max( ce.scrollWidth, ce.offsetWidth ) : ce.offsetWidth ) -
				( parseInt( c.css( "borderRightWidth" ), 10 ) || 0 ) -
				( parseInt( c.css( "paddingRight" ), 10 ) || 0 ) -
				this.helperProportions.width -
				this.margins.left -
				this.margins.right,
			( isusersScrollable ? Math.max( ce.scrollHeight, ce.offsetHeight ) : ce.offsetHeight ) -
...
var tabs = $.widget( "ui.tabs", {
	...
	_processTabs: function() {
		...
		this.tablist = this._getList()
			...
			// Prevent userss from focusing disabled tabs via click
	...
	_getIndex: function( index ) {
		// meta-function to give userss option to provide a href string instead of a numerical index.
